...
import imgCommentCourse1 from "../assets/team1.png"
...
const CommentCard = [
    {
        id: 1,
        images: imgCommentCard1,
        name: "دکتر علیرضا احمدیان",
        Biography: "داروخانه دکتر جعفری نژاد، نبش بیهق 16",
        texts: ` در توضیح یکی از معایب این دارو بهتر به این موضوع اشاره کنیم با مصرف هر چند کم این دارو، امکان خواب‌آلودگی و.کسلی مفرط در انسان ایجاد خواهد شد`
    },
    {
        id: 2,
        images: imgCommentCard2,
        name: "دکتر احمد طالب پور",
        Biography: "داروخانه سینا، خیابان کاشفی، نبش کاشفی 13",
        texts: `مصرف این دارو برای خانم‌های باردار صرفا با ترکیب مصرف
 مایعات بالا موثر خواهد بود وگرنه بیمار دچار تشنج و یا
.استرس‌های ناگهانی خواهد شد`
    },
    {
        id: 3,
        images: imgCommentCard3,
        name: "دکتر محمد صادق‌زاده",
        Biography: "داروخانه دکتر جعفری نژاد، نبش بیهق 16",
        texts: ` لورم ایپسوم یا طرح‌نما به متنی آزمایشی و بی‌معنی در
...
const CommentCourse = [
    {
        id: 1, images: imgCommentCourse1, name: "علی حسینی", Biography: "داروخانه دکتر احمدی، نبش کاشفی 13", text: ` در توضیح یکی از معایب این دارو بهتر به این موضوع 
 کنیم با مصرف هر چند کم این دارو، امکان خواب‌آلودگی و
.کسلی مفرط در انسان ایجاد خواهد شد`
    },
    {id: 2, images: imgCommentCard4, name: "دکتر احمد طالب پور", Biography: "داروخانه دکتر جعفری نژاد، نبش بیهق 16", text: ` در توضیح یکی از معایب این دارو بهتر به این موضوع 
 کنیم با مصرف هر چند کم این دارو، امکان خواب‌آلودگی و
.کسلی مفرط در انسان ایجاد خواهد شد`
    },
    {id: 3, images: imgCommentCard3, name: "دکتر محمد صادق‌زاده", Biography: "داروخانه دکتر جعفری نژاد، نبش بیهق 16", text: ` در توضیح یکی از معایب این دارو بهتر به این موضوع 
 کنیم با مصرف هر چند کم این دارو، امکان خواب‌آلودگی و
.کسلی مفرط در انسان ایجاد خواهد شد`
    },
    {id: 4, images: imgCommentCard2, name: "علیرضا نشاطی", Biography: "داروخانه دکتر جعفری نژاد، نبش بیهق 16", text: ` در توضیح یکی از معایب این دارو بهتر به این موضوع 
 کنیم با مصرف هر چند کم این دارو، امکان خواب‌آلودگی و
.کسلی مفرط در انسان ایجاد خواهد شد`
    }
]
export {item, cardmain, Cardmaintwo, CardmainThree, CardEnd, CommentCard , CommentCourse}